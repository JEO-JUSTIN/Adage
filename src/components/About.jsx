    ...
    <div className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <div className="flex items-center gap-4 mb-8">
              ...
              <span className="text-[10px] uppercase tracking-[0.5em] text-[#C8922A] font-bold">About</span>
            </div>
            <h1 className="font-cinzel font-black text-3xl md:text-4xl text-[#EDEBE6] mb-8 leading-tight uppercase">
          ...
          <div className="relative">
            <div className="absolute -top-3 -left-3 w-10 h-10 border-t border-l border-[#C8922A]/40" />
            <img
              src="/hero_banner.png"
              alt="Civil Engineering — GCE Erode"
              className="w-full h-72 lg:h-80 object-cover"
            />
            <div className="absolute -bottom-3 -right-3 w-10 h-10 border-b border-r border-[#C8922A]/40" />
          </div>
        </div>
      </section>
      ...
      <section className="border-b border-white/[0.06]">
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 divide-x divide-y md:divide-y-0 divide-white/[0.06]">
          {stats.map((s, i) => (
            <div key={i} className="px-8 py-10 text-center hover:bg-[#111] transition-colors">
              <p className="font-cinzel font-black text-4xl text-[#C8922A] mb-2">{s.num}</p>
      ...
      <section className="py-20 border-b border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-white/[0.04]">
            {values.map((v, i) => (
              <div key={i} className="bg-[#0C0C0C] p-10 hover:bg-[#0F0F0F] transition-colors border border-white/5 hover:border-[#C8922A]/20">
                <div className="text-[#C8922A] mb-5">{v.icon}</div>
                <h3 className="font-cinzel font-bold text-base text-[#EDEBE6] uppercase tracking-wider mb-3">{v.title}</h3>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            <div>
              <h3 className="font-cinzel font-bold text-xl text-[#EDEBE6] mb-6 uppercase tracking-wide">
            ...
            <div className="h-64 lg:h-full min-h-[280px] overflow-hidden border border-white/[0.06]">
              <iframe
                title="GCE Erode Map"
